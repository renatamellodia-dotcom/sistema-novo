...
export const preloadStone = {'2026-04-01':302,'2026-04-02':416,'2026-04-03':1446.8,'2026-04-04':386,'2026-04-05':310,'2026-04-06':349,'2026-04-07':199,'2026-04-08':388,'2026-04-09':74,'2026-04-10':364,'2026-04-11':285,'2026-04-12':386.3,'2026-04-13':145.99,'2026-04-14':13,'2026-04-15':572,'2026-04-16':152,'2026-04-17':342,'2026-04-18':382,'2026-04-19':464,'2026-04-20':131,'2026-04-21':344,'2026-04-22':148,'2026-04-23':475,'2026-04-25':252}

export const preloadClosings = [
  {date:'2026-04-01',maquina:302,responsavel:'Renata',obs:''},
  {date:'2026-04-02',maquina:416,responsavel:'Renata',obs:''},
  {date:'2026-04-03',maquina:1446.8,responsavel:'Renata',obs:''},
  {date:'2026-04-04',maquina:386,responsavel:'Renata',obs:''},
  {date:'2026-04-05',maquina:310,responsavel:'Renata',obs:''},
  {date:'2026-04-06',maquina:226,responsavel:'Renata',obs:''},
  {date:'2026-04-07',maquina:199,responsavel:'Renata',obs:''},
  {date:'2026-04-08',maquina:362,responsavel:'Renata',obs:''},
  {date:'2026-04-09',maquina:74,responsavel:'Renata',obs:''},
  {date:'2026-04-10',maquina:364,responsavel:'Renata',obs:''},
  {date:'2026-04-11',maquina:285,responsavel:'Renata',obs:''},
  {date:'2026-04-12',maquina:386.3,responsavel:'Renata',obs:''},
  {date:'2026-04-13',maquina:145.99,responsavel:'Renata',obs:''},
  {date:'2026-04-14',maquina:13,responsavel:'Renata',obs:''},
  {date:'2026-04-15',maquina:572,responsavel:'Renata',obs:''},
  {date:'2026-04-16',maquina:152,responsavel:'Renata',obs:''},
  {date:'2026-04-17',maquina:342,responsavel:'Renata',obs:''},
  {date:'2026-04-18',maquina:382,responsavel:'Renata',obs:''},
  {date:'2026-04-19',maquina:464,responsavel:'Renata',obs:''},
  {date:'2026-04-20',maquina:131,responsavel:'Renata',obs:''},
]

export function money(n) { return Number(n).toLocaleString('pt-BR',{style:'currency',currency:'BRL'}) }
...
const firebaseConfig = {
  apiKey: "AIzaSyALjjC-T9J3_ECZTRpz0pud6UnzT5t3yLI",
  authDomain: "sistema-complexo-9dc5a.firebaseapp.com",
  projectId: "sistema-complexo-9dc5a",
  storageBucket: "sistema-complexo-9dc5a.appspot.com",
  messagingSenderId: "417991708976",
  appId: "1:417991708976:web:b9a8da93df16f5a98738f5"
};

const app = initializeApp(firebaseConfig);
const db = getFirestore(app);

export async function getLS(key, fallback) {
  try {
    const ref = doc(db, "sistema", key);
...
export async function setLS(key, value) {
  try {
    const ref = doc(db, "sistema", key);
